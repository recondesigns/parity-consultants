...
export default function SlotContentOne() {
  return (
    <Box
      sx={{
        height: { lg: "100%" },
    ...
    >
      ...
      >
        ...
        efficiency, security, and growth. Our comprehensive services include
        cloud computing, cybersecurity, data management, and IT infrastructure.
      </Typography>
      <Box
        sx={{
          width: "100%",
